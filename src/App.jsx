...
function App() {
    ...
    const addSection = () => {
        ...
        const sectionId = `${normalizedTitle.toLowerCase().replace(/[^a-z0-9]+/g, '-').replace(/(^-|-$)/g, '')}-${Date.now()}`;
        ...
        <div className="app-shell mx-auto min-h-screen w-full max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
            ...
            <main className="grid grid-cols-1 gap-5 xl:grid-cols-[minmax(0,3fr)_minmax(0,1fr)]">
                ...
                <aside className="space-y-5">
                    <div className="panel-card panel-animate p-4 text-sm text-slate-600" style={{ animationDelay: '120ms' }}>
